...
dist_dirs:
	@mkdir -p $(TARGET_DIRECTORY)/objects 2>> $(NULLFILE) || :
	@mkdir -p $(TARGET_DIRECTORY)/bin/$(BIN_DIST_DIRECTORY_STRUCTURE) 2>> $(NULLFILE) || :
	@mkdir -p $(DIST_DIRECTORY_STRUCTURE) 2>> $(NULLFILE) || :
